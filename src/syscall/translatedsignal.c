...
static void host_signal_handler(int host_signum, siginfo_t *info,
                                void *puc) {
	assert(!" syscall emulation redirected trap");
}

static uint8_t host_to_target_signal_table[_NSIG];
static bool fill_host_to_target_signal_table()
{
	host_to_target_signal_table[SIGHUP] = TARGET_SIGHUP;
	host_to_target_signal_table[SIGINT] = TARGET_SIGINT;
	host_to_target_signal_table[SIGQUIT] = TARGET_SIGQUIT;
	host_to_target_signal_table[SIGILL] = TARGET_SIGILL;
	host_to_target_signal_table[SIGTRAP] = TARGET_SIGTRAP;
	host_to_target_signal_table[SIGABRT] = TARGET_SIGABRT;
	/* host_to_target_signal_table[SIGIOT] = TARGET_SIGIOT;*/
	host_to_target_signal_table[SIGBUS] = TARGET_SIGBUS;
	host_to_target_signal_table[SIGFPE] = TARGET_SIGFPE;
	host_to_target_signal_table[SIGKILL] = TARGET_SIGKILL;
	host_to_target_signal_table[SIGUSR1] = TARGET_SIGUSR1;
	host_to_target_signal_table[SIGSEGV] = TARGET_SIGSEGV;
	host_to_target_signal_table[SIGUSR2] = TARGET_SIGUSR2;
	host_to_target_signal_table[SIGPIPE] = TARGET_SIGPIPE;
	host_to_target_signal_table[SIGALRM] = TARGET_SIGALRM;
	host_to_target_signal_table[SIGTERM] = TARGET_SIGTERM;
#ifdef SIGSTKFLT
	host_to_target_signal_table[SIGSTKFLT] = TARGET_SIGSTKFLT;
#endif
	host_to_target_signal_table[SIGCHLD] = TARGET_SIGCHLD;
	host_to_target_signal_table[SIGCONT] = TARGET_SIGCONT;
	host_to_target_signal_table[SIGSTOP] = TARGET_SIGSTOP;
	host_to_target_signal_table[SIGTSTP] = TARGET_SIGTSTP;
	host_to_target_signal_table[SIGTTIN] = TARGET_SIGTTIN;
	host_to_target_signal_table[SIGTTOU] = TARGET_SIGTTOU;
	host_to_target_signal_table[SIGURG] = TARGET_SIGURG;
	host_to_target_signal_table[SIGXCPU] = TARGET_SIGXCPU;
	host_to_target_signal_table[SIGXFSZ] = TARGET_SIGXFSZ;
	host_to_target_signal_table[SIGVTALRM] = TARGET_SIGVTALRM;
	host_to_target_signal_table[SIGPROF] = TARGET_SIGPROF;
	host_to_target_signal_table[SIGWINCH] = TARGET_SIGWINCH;
	host_to_target_signal_table[SIGIO] = TARGET_SIGIO;
	host_to_target_signal_table[SIGPWR] = TARGET_SIGPWR;
	host_to_target_signal_table[SIGSYS] = TARGET_SIGSYS;
	/* next signals stay the same */
	/* Nasty hack: Reverse SIGRTMIN and SIGRTMAX to avoid overlap 
	   with host libpthread signals.  This assumes noone actually 
	   uses SIGRTMAX :-/ To fix this properly we need to do manual
	   signal delivery multiplexed over a single host signal.  */
	host_to_target_signal_table[__SIGRTMIN] = __SIGRTMAX;
	host_to_target_signal_table[__SIGRTMAX] = __SIGRTMIN;
	return true;
};
static uint8_t target_to_host_signal_table[_NSIG];
static bool dummy_host_to_target_signal_table =
	fill_host_to_target_signal_table();
...
bool signal_init(void)
{
    ...
    /* don't mess with the real handlers, we just want the utils */
#if 0
...
bool dummy_signal_init = signal_init();
    ...
    if (act) {
        ...
        if (host_sig != SIGSEGV && host_sig != SIGBUS) {
            ...
            if (k->_sa_handler == TARGET_SIG_IGN) {
                act1.sa_sigaction = (void (*)(int, siginfo_t*, void*))SIG_IGN;
            } else if (k->_sa_handler == TARGET_SIG_DFL) {
                if (fatal_signal (sig))
                    act1.sa_sigaction = host_signal_handler;
                else
                    act1.sa_sigaction = (void (*)(int, siginfo_t*, void*))SIG_DFL;
            } else {
                act1.sa_sigaction = host_signal_handler;
            }
...
#if 0
static int valid_user_regs(CPUState *regs)
{
    return 1;
}
#endif
